...
t_array = 0:0.001:num_pulses*2; %  seconds of "viewing"
...
tiledlayout(3,1)
nexttile
scatter(t_array,real(return_signal_pulse_train),'.',"blue")
ylabel("Amplitude")
xlabel("time (s)")
title("Return Signal w/o Noise")
nexttile
scatter(t_array,real(return_signal_pulse_train_plusNoise),'.',"red")
ylabel("Amplitude")
xlabel("time (s)")
...
nexttile
double_time = [-1*flip(t_array) t_array]
scatter(double_time(2:end),real(out),'.',"red")
ylabel("Amplitude")
xlabel("time (s)")
