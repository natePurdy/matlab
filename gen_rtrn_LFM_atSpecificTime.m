...
function [res_sig, real_part, imag_part, t_array] = gen_LFM_at_specific_time( tau, B, num_pulses, t_array, PRT, noise, time_delay, resolution )
    ...
    pulse_envelope = [ones(1,tau/resolution) zeros(1,length(t_array)-tau/resolution)];
    % remaining pulses
    for i=1:num_pulses
