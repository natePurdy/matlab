...
figure
plot(double_time1/2,abs(real(output_of_matched_filter1)),"b")
...
fontsize( 'increase')
%
% PLOT ON A "RANGE X-AXIS"
figure
plot(double_time1/2*3e8/2,abs(real(output_of_matched_filter1)),"b")
title("LFM Return Signal After MF")
ylabel("| Amplitude |")
xlabel("Range (m)")
fontsize( 'increase')
%   PLOT THE HAMMING SIGNAL OUTPUT OF THE MATCHED FILTER
figure
plot(double_time_hamm/2*3e8/2,abs(real(output_of_matched_filter_hamm)),"b")
title("LFM Return Signal After MF with hamming Window")
ylabel("| Amplitude |")
xlabel("Range (m)")
fontsize( 'increase')
